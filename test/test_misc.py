...
def test_sde_kl_divergence_weakly_diagonal(getkey):
    ...
    aug_sde, aug_y0 = diffrax.misc.sde_kl_divergence(sde1=sde1, 
                                                     sde2=sde2,
                                                     context=None, 
                                                     y0=y0)
    solver = diffrax.Euler()
    saveat = diffrax.SaveAt(ts=[1.])
    sol = diffrax.diffeqsolve(aug_sde,
                              solver=solver,
                              saveat=saveat,
                              t0=0.,
                              t1=1.,
...
def test_sde_kl_divergence_general(getkey):
