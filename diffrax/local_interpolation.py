...
class ThirdOrderHermitePolynomialInterpolation(AbstractLocalInterpolation):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.coeffs = jax.tree_util.tree_map(_calculate, y0, y1, f0, f1)
    ...
    def evaluate(
        ...
        return jax.tree_util.tree_map(_eval, self.coeffs)
...
class FourthOrderPolynomialInterpolation(AbstractLocalInterpolation):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.coeffs = jax.tree_util.tree_map(_calculate, y0, y1, k)
